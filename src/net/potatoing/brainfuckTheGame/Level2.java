...
public class Level2 extends JFrame {
	...
	public Level2() {
		...
		setTitle("Brainfuck: The Game | Level 2");
		setResizable(false);
		...
		JLabel lblWork = new JLabel("Set value of Cell 0 to be 0. Click here for hint.");
		lblWork.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseReleased(MouseEvent arg0) {
				if(lblWork.getText().equals("Set value of Cell 0 to be 0. Click here for hint."))
					lblWork.setText("Hint: Loops run, until the cell they're at is 0.");
				else
					lblWork.setText("Set value of Cell 0 to be 0. Click here for hint.");
			}
		});
		...
		if(new File("BrainfuckTheGame/BrainfuckTheGameLevel2.potato").isFile()) { 
		    txtrCode.setText("");
		    try {
				Scanner in = new Scanner(new FileReader("BrainfuckTheGame/BrainfuckTheGameLevel2.potato"));
				while (in.hasNext()) {
		...
		btnRun.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try{
					File file = new File("BrainfuckTheGame/BrainfuckTheGameLevel2.potato");
					file.getParentFile().mkdirs();
					PrintWriter out = new PrintWriter(file);
					//PrintWriter out = new PrintWriter("BrainfuckTheGameLevel2.potato");
