...
public class Level1 extends JFrame {
	...
	public Level1() {
		...
		setTitle("Brainfuck: The Game | Level 1");
		setResizable(false);
		...
		JLabel lblWork = new JLabel("Output the text: \"Hello World!\" with capital 'H' and 'W'. Click here for hint.");
		lblWork.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseReleased(MouseEvent arg0) {
				if(lblWork.getText().equals("Output the text: \"Hello World!\" with capital 'H' and 'W'. Click here for hint."))
					lblWork.setText("Set cell to ascii value and then use the '.' operator to print that value.");
				else
					lblWork.setText("Output the text: \"Hello World!\" with capital 'H' and 'W'. Click here for hint.");
			}
		});
		...
		if(new File("BrainfuckTheGame/BrainfuckTheGameLevel1.potato").isFile()) { 
		    txtrCode.setText("");
		    try {
				Scanner in = new Scanner(new FileReader("BrainfuckTheGame/BrainfuckTheGameLevel1.potato"));
				while (in.hasNext()) {
		...
		btnRun.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try{
					File file = new File("BrainfuckTheGame/BrainfuckTheGameLevel1.potato");
					file.getParentFile().mkdirs();
					PrintWriter out = new PrintWriter(file);
					//PrintWriter out = new PrintWriter("BrainfuckTheGameLevel1.potato");
		...
		btnStep.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				if(step >= size) {
					...
					if(outputStep.equals("Output: Hello World!\n") || outputStep.equals("Output: Hello World!")) {
						JOptionPane.showMessageDialog(null, "You finished this level. Congratulations!\n\nTarget program size: 105B\nYour program size: " + sizeStep + "B" + "\nTarget program used 5 cell(s).\nYour program used " + cellsUsed + " cell(s).");
						MainMenu.levelFinished[1] = true;
						MainMenu.save();
					}
				}
