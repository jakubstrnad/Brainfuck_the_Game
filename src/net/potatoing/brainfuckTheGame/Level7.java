...
public class Level7 extends JFrame {
	...
	public Level7() {
		...
		setTitle("Brainfuck: The Game | Level 7");
		setResizable(false);
		...
		JLabel lblWork = new JLabel("Set value of Cell 2 to be the quotient of cells 0 and 1. Click here for hint.");
		lblWork.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseReleased(MouseEvent arg0) {
				if(lblWork.getText().equals("Set value of Cell 2 to be the quotient of cells 0 and 1. Click here for hint."))
					lblWork.setText("Hint: Cell 2 = Cell 0 / Cell 1. TODO: Make the hints useful..(Sorry :/)");
				else
					lblWork.setText("Set value of Cell 2 to be the quotient of cells 0 and 1. Click here for hint.");
			}
		});
		...
		int i = rn.nextInt(255 - 4 + 1) + 4;
		int i2 = rn.nextInt(255 - 1 + 1) + 1;
		while(i % i2 != 0) {
			i = rn.nextInt(255 - 4 + 1) + 4;
			i2 = rn.nextInt(i-1 - 3 + 1) + 3;
		}
		...
		if(new File("BrainfuckTheGame/BrainfuckTheGameLevel7.potato").isFile()) { 
		    txtrCode.setText("");
		    try {
				Scanner in = new Scanner(new FileReader("BrainfuckTheGame/BrainfuckTheGameLevel7.potato"));
				while (in.hasNext()) {
		...
		btnRun.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try{
					File file = new File("BrainfuckTheGame/BrainfuckTheGameLevel7.potato");
					file.getParentFile().mkdirs();
					PrintWriter out = new PrintWriter(file);
					//PrintWriter out = new PrintWriter("BrainfuckTheGameLevel7.potato");
				...
				for(int k = 0; k < 3; k++) {
					...
					Random rn = new Random(); //set random value to cell 0
					int rnd1 = rn.nextInt(255 - 4 + 1) + 4;
					int rnd2 = rn.nextInt(rnd1-1 - 3 + 1) + 3;
					while(rnd1 % rnd2 != 0) {
						rnd1 = rn.nextInt(255 - 4 + 1) + 4;
		...
		btnStep.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				if(cellsStep[0] == 0 && cellsStep[1] == 0 && setCell == true) {
					Random rn = new Random(); //set random value to cell 0
					rnd1Step = rn.nextInt(255 - 4 + 1) + 4;
					rnd2Step = rn.nextInt(rnd1Step-1 - 3 + 1) + 3;
					while(rnd1Step % rnd2Step != 0) {
						rnd1Step = rn.nextInt(255 - 4 + 1) + 4;
						rnd2Step = rn.nextInt(rnd1Step-1 - 3 + 1) + 3;
					}
