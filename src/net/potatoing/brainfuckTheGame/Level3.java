...
public class Level3 extends JFrame {
	...
	public Level3() {
		...
		setTitle("Brainfuck: The Game | Level 3");
		setResizable(false);
		...
		JLabel lblWork = new JLabel("Copy the value of Cell 0 to Cell 1. Click here for hint.");
		lblWork.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseReleased(MouseEvent arg0) {
				if(lblWork.getText().equals("Copy the value of Cell 0 to Cell 1. Click here for hint."))
					lblWork.setText("Copy the value of Cell 0 to Cell 1. Hint: Try just moving the value first.");
				else
					lblWork.setText("Copy the value of Cell 0 to Cell 1. Click here for hint.");
			}
		});
		...
		if(new File("BrainfuckTheGame/BrainfuckTheGameLevel3.potato").isFile()) { 
		    txtrCode.setText("");
		    try {
				Scanner in = new Scanner(new FileReader("BrainfuckTheGame/BrainfuckTheGameLevel3.potato"));
				while (in.hasNext()) {
		...
		btnRun.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try{
					File file = new File("BrainfuckTheGame/BrainfuckTheGameLevel3.potato");
					file.getParentFile().mkdirs();
					PrintWriter out = new PrintWriter(file);
					//PrintWriter out = new PrintWriter("BrainfuckTheGameLevel3.potato");
		...
		btnStep.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				if(step == size) {
					...
					if(cellsStep[0] == rnd1Step && cellsStep[1] == rnd1Step) {
