...
public class Level5 extends JFrame {
	...
	public Level5() {
		...
		setTitle("Brainfuck: The Game | Level 5");
		setResizable(false);
		...
		JLabel lblWork = new JLabel("Set value of Cell 2 to be the multiple of cells 0 and 1. Click here for hint.");
		lblWork.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseReleased(MouseEvent arg0) {
				if(lblWork.getText().equals("Set value of Cell 2 to be the multiple of cells 0 and 1. Click here for hint."))
					lblWork.setText("Hint: Do level 2 and level 3 first. This is very simmilar. (3*4 = 3+3+3+3)");
				else
					lblWork.setText("Set value of Cell 2 to be the multiple of cells 0 and 1. Click here for hint.");
			}
		});
		...
		if(new File("BrainfuckTheGame/BrainfuckTheGameLevel5.potato").isFile()) { 
		    txtrCode.setText("");
		    try {
				Scanner in = new Scanner(new FileReader("BrainfuckTheGame/BrainfuckTheGameLevel5.potato"));
				while (in.hasNext()) {
		...
		btnRun.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try{
					File file = new File("BrainfuckTheGame/BrainfuckTheGameLevel5.potato");
					file.getParentFile().mkdirs();
					PrintWriter out = new PrintWriter(file);
					//PrintWriter out = new PrintWriter("BrainfuckTheGameLevel5.potato");
				...
				for(int k = 0; k < 3; k++) {
					...
					Random rn = new Random(); //set random value to cell 0
					int rnd1 = rn.nextInt(10 - 1 + 1) + 1;
					int rnd2 = rn.nextInt(10 - 1 + 1) + 1;
					cells[0] = rnd1;
					cells[1] = rnd2;
