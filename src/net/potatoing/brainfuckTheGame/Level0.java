...
public class Level0 extends JFrame {
	...
	public Level0() {
		...
		setTitle("Brainfuck: The Game | Level 0");
		setResizable(false);
		...
		JLabel lblWork = new JLabel("Set the value of Cell 0 to be 5. Click here for hint.");
		lblWork.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseReleased(MouseEvent arg0) {
				if(lblWork.getText().equals("Set the value of Cell 0 to be 5. Click here for hint."))
					lblWork.setText("Set the value of Cell 0 to be 5. Hint: Use Brainfuck to solve this level.");
				else
					lblWork.setText("Set the value of Cell 0 to be 5. Click here for hint.");
			}
		});
		...
		if(new File("BrainfuckTheGame/BrainfuckTheGameLevel0.potato").isFile()) { 
		    txtrCode.setText("");
		    try {
				Scanner in = new Scanner(new FileReader("BrainfuckTheGame/BrainfuckTheGameLevel0.potato"));
				while (in.hasNext()) {
		...
		btnRun.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try{
					File file = new File("BrainfuckTheGame/BrainfuckTheGameLevel0.potato");
					file.getParentFile().mkdirs();
					PrintWriter out = new PrintWriter(file);
					//PrintWriter out = new PrintWriter("BrainfuckTheGameLevel0.potato");
		...
		btnStep.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				if(cellsStep[0] == 5 || cellsStep[0] == 53) {
