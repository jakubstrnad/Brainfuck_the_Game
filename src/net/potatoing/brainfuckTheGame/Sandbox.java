...
public class Sandbox extends JFrame {
	...
	public Sandbox() {
		...
		setTitle("Brainfuck: The Game | Sandbox");
		setResizable(false);
		...
		JLabel lblWork = new JLabel("Sandbox");
		lblWork.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseReleased(MouseEvent arg0) {
				lblWork.setText("Sandbox. Enjoy the joys of Brainfuck.");
			}
		});
		...
		if(new File("BrainfuckTheGame/BrainfuckTheGameSandbox.potato").isFile()) { 
		    txtrCode.setText("");
		    try {
				Scanner in = new Scanner(new FileReader("BrainfuckTheGame/BrainfuckTheGameSandbox.potato"));
				while (in.hasNext()) {
