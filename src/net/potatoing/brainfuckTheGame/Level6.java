...
public class Level6 extends JFrame {
	...
	public Level6() {
		...
		setTitle("Brainfuck: The Game | Level 6");
		setResizable(false);
		...
		JLabel lblWork = new JLabel("Set value of Cell 0 to be the initial value of Cell 0 ^ 3. Click here for hint.");
		lblWork.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseReleased(MouseEvent arg0) {
				if(lblWork.getText().equals("Set value of Cell 0 to be the initial value of Cell 0 ^ 3. Click here for hint."))
					lblWork.setText("Hint: Use your multiplication code. x^3=x*x*x");
				else
					lblWork.setText("Set value of Cell 0 to be the initial value of Cell 0 ^ 3. Click here for hint.");
			}
		});
		...
		if(new File("BrainfuckTheGame/BrainfuckTheGameLevel6.potato").isFile()) { 
		    txtrCode.setText("");
		    try {
				Scanner in = new Scanner(new FileReader("BrainfuckTheGame/BrainfuckTheGameLevel6.potato"));
				while (in.hasNext()) {
		...
		btnRun.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try{
					File file = new File("BrainfuckTheGame/BrainfuckTheGameLevel6.potato");
					file.getParentFile().mkdirs();
					PrintWriter out = new PrintWriter(file);
					//PrintWriter out = new PrintWriter("BrainfuckTheGameLevel6.potato");
				...
				for(int k = 0; k < 3; k++) {
					...
					if(cells[0] == rnd1*rnd1*rnd1) {
						success++;
						System.out.println(success);
					} else {
						JOptionPane.showMessageDialog(null, "Your code doesn't work, if Cell 0 is " + rnd1 + "!\nTry again.");
						k = 2;
					}
				}
		...
		btnStep.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				if(cellsStep[0] == 0 && setCell == true) {
					rnd1Step = rn.nextInt(6 - 1 + 1) + 1;
				...
				if(step == size) {
					...
					if(cellsStep[0] == rnd1Step*rnd1Step*rnd1Step) {
